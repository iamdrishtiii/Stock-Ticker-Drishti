    ...
    <>
      <div className="max-h-full min-h-screen" style={{ backgroundImage: "url('/R.jpeg')", backgroundSize: "cover", backgroundPosition: "center", height: "screen" }}>
        ...
        <main className='max-w-[960px] mx-0 my-auto sm:px-24 py-12'>
          ...
          <form onChange={handleSearch}  className='w-[100%] px-4 sm:px-12 py-3 border text-white font-semibold rounded-full shadow-lg mb-8 flex flex-row'>
            <input
              value={searchTerm}
              ...
              className='w-[100%]'
            />
            <button className='bg-blue-400 px-2 py-1 rounded-xl'>Search</button>
          </form>
